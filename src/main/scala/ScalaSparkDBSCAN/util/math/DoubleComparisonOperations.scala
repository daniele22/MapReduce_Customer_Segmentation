package ScalaSparkDBSCAN.util.math


private [ScalaSparkDBSCAN] class DoubleComparisonOperations (val originalValue: Double) {
...
private [ScalaSparkDBSCAN] object DoubleComparisonOperations {
