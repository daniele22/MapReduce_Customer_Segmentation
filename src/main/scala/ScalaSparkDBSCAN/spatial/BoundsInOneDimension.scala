...
/** Represents lower and upper bound along each dimension. Very similar to the Range class
  ...
  */
private [ScalaSparkDBSCAN] class BoundsInOneDimension (val lower: Double, val upper: Double,
  ...
  /** Splits this object into a number of equal parts
    ...
    * @return A list of [[ScalaSparkDBSCAN.spatial.BoundsInOneDimension]]
    */
...
private [ScalaSparkDBSCAN] object BoundsInOneDimension extends Serializable {
