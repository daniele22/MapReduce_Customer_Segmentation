...
import ScalaSparkDBSCAN.dbscan.PairOfAdjacentBoxIds
 ...
 */
private [ScalaSparkDBSCAN] class PointsInAdjacentBoxesRDD (prev: RDD[(PairOfAdjacentBoxIds, Point)], val adjacentBoxIdPairs: Array[PairOfAdjacentBoxIds])
  extends ShuffledRDD [PairOfAdjacentBoxIds, Point, Point] (prev, new AdjacentBoxesPartitioner(adjacentBoxIdPairs)) with Serializable

private [ScalaSparkDBSCAN] object PointsInAdjacentBoxesRDD extends Serializable {
