...
/** Represents a box-shaped region in multi-dimensional space
  ...
  */
private [ScalaSparkDBSCAN] class Box (val bounds: Array[BoundsInOneDimension],
                                       val boxId: BoxId = 0, val partitionId: Int = -1,
                                       @transient var adjacentBoxes: List[Box] = Nil)
  ...
  private [ScalaSparkDBSCAN] def findLongestDimensionAndItsIndex ()
  ...
  private [ScalaSparkDBSCAN] def calculateCenter (b: Array[BoundsInOneDimension]): Point = {
