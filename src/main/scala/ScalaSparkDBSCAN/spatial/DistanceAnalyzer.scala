...
import ScalaSparkDBSCAN.spatial.rdd._
import org.apache.commons.math3.ml.distance.DistanceMeasure
import ScalaSparkDBSCAN._
import ScalaSparkDBSCAN.dbscan.{PairOfAdjacentBoxIds, PointCoordinates}
...
private [ScalaSparkDBSCAN] class DistanceAnalyzer (
  ...
  def countClosePoints(data: PointsPartitionedByBoxesRDD): RDD[(PointSortKey, Long)] = {
  ...
  private [ScalaSparkDBSCAN] def addPointCount (counts: mutable.HashMap[PointSortKey, Long], sortKey: PointSortKey, c: Long) = {
