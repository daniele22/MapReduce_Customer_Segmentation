 ...
 *
 */
object ExploratoryAnalysisHelper extends Serializable {

  private [ScalaSparkDBSCAN] val DefaultNumberOfBucketsInHistogram = 16

  private [ScalaSparkDBSCAN] implicit def toRDDWithLongIndexesAndDoubleValues (
  ...
  private [ScalaSparkDBSCAN] def calculateHistogram (
  ...
  private [ScalaSparkDBSCAN] def convertHistogramToTriples (
